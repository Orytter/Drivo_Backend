...
exports.sendToZohoWithoutAwaitContactRequest = void 0;
// // zohoMiddleware.js
...
const sendToZohoWithoutAwaitContactRequest = async (zohoCredential, data) => {
  try {
    const config = {
      method: 'post',
      maxBodyLength: Infinity,
...
exports.sendToZohoWithoutAwaitContactRequest = sendToZohoWithoutAwaitContactRequest;